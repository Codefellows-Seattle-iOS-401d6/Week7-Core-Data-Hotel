...
-(void)saveButtonSelected:(UIBarButtonItem *)sender {
    self.room.reservation = [self.reservService saveReservation:self.startDate endDate:self.endDate room:self.room name:self.nameField.text lastName:self.lastNameField.text email:self.emailField.text];
