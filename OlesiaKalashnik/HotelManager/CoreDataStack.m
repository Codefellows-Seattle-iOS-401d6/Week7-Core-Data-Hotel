...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    if (![_persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeURL options:nil error:&error]) { //for testing: change store type to NSInMemoryStoreType
