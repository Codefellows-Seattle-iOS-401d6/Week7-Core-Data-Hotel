...
-(Reservation *)saveReservation:(NSDate *)startDate endDate:(NSDate *)endDate room:(Room *)room name:(NSString *)name lastName:(NSString *)lastName email:(NSString *)email phoneNumber: (NSString *)phoneNumber {
    Reservation *reservation = [Reservation reservationWithStartDate: startDate endDate:endDate room: room];
    reservation.guest = [Guest guestWithName:name lastName:lastName email:email phoneNumber:phoneNumber];
