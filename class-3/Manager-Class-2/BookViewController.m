...
//        {
//        [ReservationService bookHotel:self.startDate endDate:self.endDate room:self.room nameField:self.nameField lastNameField:self.lastNameField email:self.emailField];
//        }
//        else
//        {
//            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Hmmm...." message:@"Please fill out all required sections" preferredStyle:UIAlertControllerStyleAlert];
