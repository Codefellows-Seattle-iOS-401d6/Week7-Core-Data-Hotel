...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"Room: %i (%i beds, $%0.2f)",room.roomNumber.intValue, room.beds.intValue, room.rate.floatValue];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ReserveViewController *reserveViewController = [[ReserveViewController alloc]init];
